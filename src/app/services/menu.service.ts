...
export class MenuService {
  ...
  private ingredients: Ingredient[] = [
    ...
    { id: 6, name: 'Vanilla Syrup', cost: 0.12, unit: 'ml', stockAmount: 400, reorderThreshold: 500 },
    ...
    { id: 10, name: 'Sugar', cost: 0.03, unit: 'grams', stockAmount: 500, reorderThreshold: 600 }
  ];
